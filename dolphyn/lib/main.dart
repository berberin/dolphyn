...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() async {
    WalletService.checkBalance().then((value) => print(value));
    var wl = await WalletService.createNewWallet();
    print(HEX.encode(wl.privateKey.privateKey));
    print(wl.address.hex);
  }
